...
9. - To build and run your project, you have to make your own tasks using west build and flash. You probably want to use local tasks for that.
 - When building your project don't change the name of the build folder. It has to be called build for clangd to work properly
