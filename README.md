...
6a. To launch Zed in the correct environment, launch it with the [shortcut](./windows/launch_zed_ncs.lnk) _(you may change the shortcut command to change the ncs version you want to launch)_
